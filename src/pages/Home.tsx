      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold gradient-text">AuraSkill AI</span>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-violet-500/5 to-purple-500/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Join AuraSkill AI today and get personalized AI guidance for interviews, resumes, and career growth.
          </p>
          <Button size="lg" onClick={() => navigate('/login')}
      ...
      <footer className="border-t border-border/50 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold gradient-text">AuraSkill AI</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2024 AuraSkill AI. AI-Powered Career Companion.</p>
        </div>
      </footer>
    </div>
  );
