...
import LiveJobScraper from "./pages/LiveJobScraper";
          ...
          <ResumeProvider>
            <BrowserRouter>
              <InterviewProvider>
                ...
                <Route path="/live-jobs" element={<AuthGuard><LiveJobScraper /></AuthGuard>} />
                <Route path="/profile-analyzer" element={<AuthGuard><ProfileAnalyzer /></AuthGuard>} />
                <Route path="/learning-pathway" element={<AuthGuard><LearningPathway /></AuthGuard>} />
                <Route path="/resume-jd-match" element={<AuthGuard><ResumeJDMatcher /></AuthGuard>} />
                <Route path="/jd-analyzer" element={<AuthGuard><JDAnalyzer /></AuthGuard>} />
