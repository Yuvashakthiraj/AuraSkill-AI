...
import {
    ...
    Briefcase, Code, Wrench, Info, Loader2
} from 'lucide-react';
...
import { extractSkillsFromJD, type JDExtractionResponse } from '@/utils/auraSkillService';
...
We are looking for an experienced Senior Software Engineer to join our growing engineering team. You will be responsible for building scalable web applications and working across the full stack.

Requirements:
• 5+ years of experience in software development
• Strong proficiency in JavaScript/TypeScript and React
• Experience with Node.js, Express, or similar backend frameworks
• Solid understanding of Python for backend services
...
• Familiarity with machine learning concepts and TensorFlow/PyTorch
• Experience with Redis, ElasticSearch, or other caching solutions
• Understanding of security best practices and OAuth 2.0

Tools & Technologies:
Git, Jira, Confluence, Slack, Postman, VS Code
...
const ResumeUploadSection = () => {
    ...
    const [jdResult, setJdResult] = useState<JDExtractionResponse | null>(null);
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (f) {
            ...
            setFile(f); setError(''); setResume(null); setSkillGapAnalysis(null); setJdResult(null);
        }
    };
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                    ...
                    <Card className="border-blue-500/30 bg-gradient-to-br from-blue-500/5 to-indigo-500/5">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Paste a job description to extract skills and compare with your resume
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            {/* Info Badge */}
                            <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    <span className="font-semibold text-blue-400">NLP Method:</span> AI (llama-3.3-70b-versatile) performs semantic parsing 
                                    to extract required skills, preferred skills, tools, experience level, and domain from unstructured job descriptions.
                                </p>
                            </div>
...
Example: We are looking for a Senior Software Engineer with 5+ years of experience in Python, React, and AWS. The ideal candidate should have experience with microservices architecture, Docker, and CI/CD pipelines..."
                            ...
                            <div className="flex gap-3">
                                <Button
                                    ...
                                    disabled={jdLoading || !jdText.trim() || jdText.trim().length < 50}
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                            <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/30">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-semibold text-sm">{jdResult.analysis.experience_level}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/30">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-semibold text-sm">{jdResult.analysis.domain}</p>
                                                </div>
                                            </div>
                                            <div className="col-span-2 md:col-span-1 p-3 rounded-lg bg-muted/30">
                                                <p className="text-xs text-muted-foreground mb-1">Summary</p>
                                                <p className="text-xs">{jdResult.analysis.summary}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-xs flex items-center gap-1">
                                                    ...
                                                    Required ({jdResult.analysis.required_skills.length})
                                                </Label>
                                                <div className="flex flex-wrap gap-1.5">
                                                    {jdResult.analysis.required_skills.map((skill, i) => (
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-xs flex items-center gap-1">
                                                    ...
                                                    Preferred ({jdResult.analysis.preferred_skills.length})
                                                </Label>
                                                <div className="flex flex-wrap gap-1.5">
                                                    {jdResult.analysis.preferred_skills.map((skill, i) => (
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-xs flex items-center gap-1">
                                                    ...
                                                    Tools ({jdResult.analysis.tools.length})
                                                </Label>
                                                <div className="flex flex-wrap gap-1.5">
                                                    {jdResult.analysis.tools.map((tool, i) => (
...
const ResumeBuilderSection = () => {
    ...
    const generatePDF = () => {
        ...
        const fileName = `${personalInfo.name ? personalInfo.name.replace(/[^a-zA-Z0-9 -]/g, '') : 'resume'}_AuraSkill_AI.pdf`;
